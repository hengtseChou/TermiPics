  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="flex flex-col items-center justify-center text-green-500 font-mono">
        ...
        <div className="mt-10 w-full max-w-2xl p-6 bg-gray-900 rounded-lg shadow-lg border border-green-500 text-center">
        ...
        <p className="mt-6 text-xs text-green-500">[ All_Systems_Operational ]</p>
      </div>
    </div>
  );
}
